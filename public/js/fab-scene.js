...

  {
    ...
    defaultItems: {
      ...
      slash: [
        ...
        { id: 'cost',        label: '/cost',        send: '/cost\r' },
        { id: 'model',       label: '/model',       send: '/model\r' },
        { id: 'fast',        label: '/fast',        send: '/fast\r' },
        { id: 'permissions', label: '/permissions',  send: '/permissions\r' },
        { id: 'status',      label: '/status',      send: '/status\r' },
        { id: 'memory',      label: '/memory',      send: '/memory\r' },
        { id: 'config',      label: '/config',      send: '/config\r' },
        { id: 'vim',         label: '/vim',         send: '/vim\r' },
        { id: 'doctor',      label: '/doctor',      send: '/doctor\r' },
        { id: 'bug',         label: '/bug',         send: '/bug\r' },
        { id: 'login',       label: '/login',       send: '/login\r' },
        { id: 'logout',      label: '/logout',      send: '/logout\r' },
        // Workflow
        ...
        // User skills
        { id: 'pua',              label: '/pua',              send: '/pua\r' },
        { id: 'pua-p9',           label: '/pua:p9',           send: '/pua:p9\r' },
        { id: 'pua-loop',         label: '/pua:pua-loop',     send: '/pua:pua-loop\r' },
        { id: 'pua-yes',          label: '/pua:yes',          send: '/pua:yes\r' },
        { id: 'pua-mama',         label: '/pua:mama',         send: '/pua:mama\r' },
        { id: 'work-log',         label: '/work-log',         send: '/work-log\r' },
        { id: 'arm-cloud-ctl',    label: '/arm-cloud-ctl',    send: '/arm-cloud-ctl\r' },
        { id: 'project-map',      label: '/project-map',      send: '/project-map\r' },
        { id: 'webapp-testing',   label: '/webapp-testing',   send: '/webapp-testing\r' },
        { id: 'deploy-android',   label: '/deploy-android-container', send: '/deploy-android-container\r' },
        { id: 'security-review',  label: '/security-review',  send: '/security-review\r' },
      ],
      templates: [
